...
/>`}</pre>
        ...
        {/* Pricing */}
        <section id="pricing" className="w-full py-20 bg-gray-50 scroll-mt-16">
          <div className="container px-4 md:px-6 max-w-7xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              ...
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                Pay only for what you use. No setup fees, no monthly charges, no hidden costs.
              </p>
            </div>
            ...
            <div className="max-w-3xl mx-auto">
              <div className="border border-gray-200 rounded-lg p-8 bg-white">
                <div className="flex items-baseline gap-2 mb-6">
                  ...
                  <span className="text-gray-600">per order processed</span>
                </div>
                <p className="text-gray-600 mb-8">
                  Plus margins on negotiated logistics rates. The more volume you process, the lower your per-order cost.
                </p>
                <div className="space-y-4 mb-8">
                  ...
                  <div className="flex items-center gap-3">
                    <Check className="h-5 w-5 text-green-600 flex-shrink-0" />
                    <span className="text-gray-700">All carrier integrations included</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <Check className="h-5 w-5 text-green-600 flex-shrink-0" />
                    <span className="text-gray-700">Smart logistics consolidation</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <Check className="h-5 w-5 text-green-600 flex-shrink-0" />
                    <span className="text-gray-700">Policy engine & Buyer Guard</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <Check className="h-5 w-5 text-green-600 flex-shrink-0" />
                  ...
                  <div className="flex items-center gap-3">
                    <Check className="h-5 w-5 text-green-600 flex-shrink-0" />
                    <span className="text-gray-700">Automatic settlement & returns</span>
                  </div>
                </div>
              ...
              <div className="mt-8 text-center">
                <p className="text-sm text-gray-600">
                  Volume discounts available for enterprise. <Link href="/contact" className="text-gray-900 underline">Contact sales</Link>
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="container px-4 md:px-6 max-w-7xl mx-auto">
            <div className="grid md:grid-cols-4 gap-8 text-center">
              ...
              <div>
                ...
                <div className="text-gray-600">Monthly GMV</div>
              </div>
              <div>
            ...
            <div className="max-w-4xl mx-auto">
              <div className="text-center mb-12">
                ...
                <p className="text-lg text-gray-600">
                  Commerce in emerging markets is broken after checkout—not before it
                </p>
              </div>
                ...
                <div className="bg-white border border-gray-200 rounded-lg p-6">
                  ...
                  <ul className="space-y-3 text-gray-600">
                    <li className="flex items-start gap-2">
                      ...
                      <span>Fragmented logistics with unreliable carriers</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-gray-400 mt-1">•</span>
                      <span>40-60% checkout abandonment due to delivery uncertainty</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-gray-400 mt-1">•</span>
                      <span>No enforcement layer for COD and return policies</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-gray-400 mt-1">•</span>
                      <span>Manual coordination across spreadsheets and DMs</span>
                    </li>
                  </ul>
                </div>

                <div className="bg-white border border-gray-200 rounded-lg p-6">
                  <h3 className="text-xl font-semibold text-gray-900 mb-4">The market</h3>
                  <ul className="space-y-3 text-gray-600">
                    <li className="flex items-start gap-2">
                      <span className="text-gray-400 mt-1">•</span>
                      <span>$800B+ global logistics TAM</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-gray-400 mt-1">•</span>
                      <span>$40B+ social commerce logistics in Africa</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-gray-400 mt-1">•</span>
                      <span>$15B addressable in micro/SME segment</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-gray-400 mt-1">•</span>
                      <span>Growing 40%+ annually</span>
                    </li>
                  </ul>
                </div>
              </div>
              ...
              <div className="bg-gray-900 text-white rounded-lg p-8 text-center">
                <h3 className="text-2xl font-bold mb-4">
                  Pluggn turns fulfillment chaos into coordinated infrastructure
                </h3>
                <p className="text-gray-300 text-lg">
                  We're building the invisible backend that makes commerce work in emerging markets—
      ...
      <footer className="w-full border-t bg-gray-50 py-12">
        <div className="container px-4 md:px-6 max-w-7xl mx-auto">
          <div className="grid md:grid-cols-4 gap-8">
            <div>
              <div className="text-xl font-bold text-gray-900 mb-4">Pluggn</div>
              <p className="text-sm text-gray-600">
          ...
          <div className="mt-12 pt-8 border-t text-center text-sm text-gray-600">
            <p>© 2025 Pluggn. All rights reserved.</p>
          </div>
        </div>
      </footer>
