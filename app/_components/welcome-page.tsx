                ...
                <div className="flex items-center gap-3">
                  ...
                  <div className="text-left">
                    ...
                    <p className="text-gray-600 text-xs md:text-sm">
                      Quality-verified products • Secure payments • Full refund
                      protection
                    </p>
                  </div>
                </div>
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  ...
                  >
                    ...
                    <p className="text-white/90 text-sm">
                      Start earning without inventory, logistics issues, or
                      upfront costs
                    </p>
            ...
            <div className="max-w-6xl mx-auto">
              <div className="text-center mb-12">
                ...
                <p className="text-lg md:text-xl text-gray-600 max-w-3xl mx-auto">
                  ...
                  logistics issues, or technical skills. Join thousands making
                  ₦100K+ monthly.
                </p>
              </div>
            ...
            <div className="max-w-6xl mx-auto">
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                ...
                <div className="bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-shadow ">
                  ...
                  <h3 className="text-xl font-bold text-center mb-3">
                    Quality Assurance & Buyer Protection
                  </h3>
                  <p className="text-gray-600 text-center text-sm">
                    When purchasing from a Pluggn store, buyers can be totally
                    assured of premium product quality. We carefully handpick
                    and verify every product from trusted suppliers, ensuring
                    only the highest standards reach our customers.
                  </p>
                </div>
                {/* Buyer Trust & Safety */}
                <div className="bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-shadow ">
            ...
            <div className="max-w-6xl mx-auto">
              ...
              <div className="grid md:grid-cols-3 gap-8">
                ...
                <div className="bg-white rounded-2xl p-6 shadow-lg">
                  ...
                  <p className="text-gray-700 mb-4">
                    "Started with no capital. Now I make around ₦100,000 monthly
                    just sharing products on WhatsApp. Omo pluggn changed my
                    life completely!"
                  </p>
                  <div className="flex items-center justify-between">
                    <div className="flex">
              ...
              <div className="space-y-6">
                ...
                <div className="bg-gradient-to-br from-orange-50 to-pink-50 rounded-2xl p-6">
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 text-sm">
                        You can withdraw your margin to your account 3 days
                ...
                <div className="bg-gradient-to-br from-orange-50 to-pink-50 rounded-2xl p-6">
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      <h4 className="font-semibold mb-2">
                        How can buyers be sure of product quality?
                      </h4>
                      <p className="text-gray-600 text-sm">
                        When purchasing from a Pluggn store, buyers can be
                        totally assured of premium product quality. Every
                        product is carefully vetted by our quality team, and we
                        offer a 100% money-back guarantee if customers aren't
