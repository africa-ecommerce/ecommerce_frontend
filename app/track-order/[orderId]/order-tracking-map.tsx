      ...
      >
        ...
        <div className="bg-white/90 backdrop-blur-sm rounded-xl shadow-lg overflow-hidden">
          <Button
            variant="ghost"
            size="sm"
            className="w-12 h-12 p-0 rounded-none border-b hover:bg-blue-50 transition-colors duration-200"
            onClick={zoomIn}
            disabled={zoom >= 18}
          >
          ...
          <Button
            variant="ghost"
            size="sm"
            className="w-12 h-12 p-0 rounded-none hover:bg-blue-50 transition-colors duration-200"
            onClick={zoomOut}
            disabled={zoom <= 1}
          >
        ...
        <Button
          variant="outline"
          size="sm"
          className="bg-white/90 backdrop-blur-sm hover:bg-blue-50 transition-all duration-200 w-12 h-12 p-0 rounded-xl shadow-lg"
          onClick={fitBounds}
