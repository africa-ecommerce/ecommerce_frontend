...
export async function GET(
  ...
  try {
    ...
    // Use a placeholder image if fetching remote images fails
    // The ImageResponse component can't reliably determine dimensions of external images
    const usePlaceholderImage = true; // Set to true to use placeholder instead of remote images
    const placeholderColor = "#F3F4F6"; // Light gray background
        ...
        >
          ...
          >
            ...
            >
              ...
              {/* Product description or category if description is empty */}
              <p
                style={{
                  fontSize: 24,
                  color: "#4B5563",
              ...
              {product.supplier && (
                ...
                >
                  Seller: {product.supplier.businessName}
                </p>
              )}
            </div>
          </div>
