  ...
  return (
    <TooltipProvider>
      <div className="flex flex-col min-h-screen bg-background p-3 sm:p-4 md:p-6 gap-4 sm:gap-6 animate-fade-in">
        ...
        <section className="space-y-3 sm:space-y-4">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
            <h2 className="text-base sm:text-lg font-semibold">Distribution Network</h2>
            <div className="flex gap-2">
              <Input
                placeholder="Search plugs..."
                className="h-7 sm:h-8 w-[120px] sm:w-[150px] md:w-[200px] text-xs sm:text-sm"
              />
              <Button variant="outline" size="sm" asChild className="text-xs sm:text-sm">
          ...
          <Card>
            <CardHeader className="p-3 sm:p-4 pb-1 sm:pb-2">
              <CardTitle className="text-sm sm:text-base font-medium">Top Performing Plugs</CardTitle>
            </CardHeader>
            <CardContent className="p-3 sm:p-4 pt-0">
              <div className="space-y-3 sm:space-y-4">
                {/* Plug 1 */}
                <div className="flex items-center gap-2 sm:gap-3">
                  <Avatar className="h-8 w-8 sm:h-10 sm:w-10">
                    <AvatarImage src="/placeholder.svg?height=40&width=40" alt="Plug" />
                    <AvatarFallback>AD</AvatarFallback>
                  </Avatar>
                  <div className="flex-1 min-w-0">
                    <div className="flex justify-between items-center gap-1">
                      <p className="text-xs sm:text-sm font-medium truncate">Ade Johnson</p>
                      <p className="text-xs sm:text-sm font-medium whitespace-nowrap">₦245K</p>
                    </div>
                    <div className="flex justify-between text-[10px] xs:text-xs text-muted-foreground">
                      <p className="truncate">Lagos, Nigeria • 120 orders</p>
                      <p className="text-green-600 whitespace-nowrap">+18% this month</p>
                    </div>
                ...
                <div className="flex items-center gap-2 sm:gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex justify-between items-center gap-1">
                      <p className="text-xs sm:text-sm font-medium truncate">Fatima Osei</p>
                      <p className="text-xs sm:text-sm font-medium whitespace-nowrap">₦180K</p>
                    </div>
                    <div className="flex justify-between text-[10px] xs:text-xs text-muted-foreground">
                      <p className="truncate">Accra, Ghana • 85 orders</p>
                      <p className="text-green-600 whitespace-nowrap">+12% this month</p>
                    </div>
                ...
                <div className="flex items-center gap-2 sm:gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex justify-between items-center gap-1">
                      <p className="text-xs sm:text-sm font-medium truncate">John Nduka</p>
                      <p className="text-xs sm:text-sm font-medium whitespace-nowrap">₦120K</p>
                    </div>
                    <div className="flex justify-between text-[10px] xs:text-xs text-muted-foreground">
                      <p className="truncate">Nairobi, Kenya • 62 orders</p>
                      <p className="text-amber-600 whitespace-nowrap">-2% this month</p>
                    </div>
                    <Progress value={55} className="h-1 mt-1" />
                  </div>
                  <Button variant="ghost" size="sm" className="h-7 w-7 sm:h-8 sm:w-8">
                    <ChevronRight className="h-3.5 w-3.5 sm:h-4 sm:w-4" />
                  </Button>
            ...
            <CardFooter className="p-3 sm:p-4 pt-0 flex justify-center">
              <Button variant="outline" size="sm" className="text-xs sm:text-sm h-7 sm:h-8">
                <Users className="h-3.5 w-3.5 sm:h-4 sm:w-4 mr-1" /> Find New Plugs
              </Button>
            </CardFooter>
          </Card>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4">
            <Card>
              <CardHeader className="p-3 sm:p-4 pb-1 sm:pb-2">
                <CardTitle className="text-sm sm:text-base font-medium">Product Distribution</CardTitle>
                <CardDescription className="text-xs sm:text-sm">Which products are selling where</CardDescription>
              </CardHeader>
              <CardContent className="p-3 sm:p-4 pt-0">
                <div className="h-[150px] sm:h-[200px] flex items-center justify-center">
                  <PieChart className="h-24 w-24 sm:h-32 sm:w-32 text-primary/20" />
                </div>
                <div className="space-y-1 sm:space-y-2 mt-2">
                  <div className="flex items-center gap-2">
                    <div className="w-2 h-2 sm:w-3 sm:h-3 rounded-full bg-primary"></div>
                    <span className="text-[10px] xs:text-xs">Shea Butter (45%)</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <div className="w-2 h-2 sm:w-3 sm:h-3 rounded-full bg-primary/80"></div>
                    <span className="text-[10px] xs:text-xs">Black Soap (30%)</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <div className="w-2 h-2 sm:w-3 sm:h-3 rounded-full bg-primary/60"></div>
                    <span className="text-[10px] xs:text-xs">Hair Oils (15%)</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <div className="w-2 h-2 sm:w-3 sm:h-3 rounded-full bg-primary/40"></div>
                    <span className="text-[10px] xs:text-xs">Body Butters (10%)</span>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardHeader className="p-3 sm:p-4 pb-1 sm:pb-2">
                <CardTitle className="text-sm sm:text-base font-medium">Geographic Reach</CardTitle>
                <CardDescription className="text-xs sm:text-sm">Where your products are selling</CardDescription>
              </CardHeader>
              <CardContent className="p-3 sm:p-4 pt-0">
                <div className="h-[150px] sm:h-[200px] flex items-center justify-center">
                  <BarChart3 className="h-24 w-24 sm:h-32 sm:w-32 text-primary/20" />
                </div>
                <div className="space-y-1 sm:space-y-2 mt-2">
                  <div className="flex justify-between items-center">
                    <span className="text-[10px] xs:text-xs">Nigeria</span>
                    <Progress value={65} className="h-1.5 sm:h-2 w-[60%] sm:w-[70%]" />
                    <span className="text-[10px] xs:text-xs font-medium">65%</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-[10px] xs:text-xs">Ghana</span>
                    <Progress value={20} className="h-1.5 sm:h-2 w-[60%] sm:w-[70%]" />
                    <span className="text-[10px] xs:text-xs font-medium">20%</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-[10px] xs:text-xs">Kenya</span>
                    <Progress value={10} className="h-1.5 sm:h-2 w-[60%] sm:w-[70%]" />
                    <span className="text-[10px] xs:text-xs font-medium">10%</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-[10px] xs:text-xs">Other</span>
                    <Progress value={5} className="h-1.5 sm:h-2 w-[60%] sm:w-[70%]" />
                    <span className="text-[10px] xs:text-xs font-medium">5%</span>
                  </div>
                </div>
              </CardContent>
            </Card>
