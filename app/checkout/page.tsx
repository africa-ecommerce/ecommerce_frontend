...
import { CreditCard, Truck, MapPin, Plus, Banknote } from "lucide-react"
                ...
                <CardContent className="p-4 md:p-6">
                  ...
                  <div className="space-y-6">
                    <div>
                      ...
                      <RadioGroup value={selectedAddress} onValueChange={setSelectedAddress} className="space-y-4 mb-4">
                        <Card className="overflow-hidden border-primary">
                          <CardContent className="p-3 md:p-4">
                            <div className="flex items-start">
                              <div className="mr-3 mt-0.5 flex-shrink-0">
                                <RadioGroupItem id="address-1" value="address-1" />
                              </div>
                              <div className="flex-1 min-w-0">
                                <div className="flex justify-between items-start">
                                  <Label htmlFor="address-1" className="font-medium">
                                    Home
                                  </Label>
                        ...
                        <Card className="overflow-hidden">
                          <CardContent className="p-3 md:p-4">
                            <div className="flex items-start">
                              <div className="mr-3 mt-0.5 flex-shrink-0">
                                <RadioGroupItem id="address-2" value="address-2" />
                              </div>
                              <div className="flex-1 min-w-0">
                                <Label htmlFor="address-2" className="font-medium">
                                  Office
                                </Label>
                                <p className="text-sm text-muted-foreground mt-1">
                                  Amina Mohammed
                      ...
                      <RadioGroup value={deliveryMethod} onValueChange={setDeliveryMethod} className="space-y-3">
                        <div className="flex items-center justify-between space-x-2 p-3 border rounded-md">
                          <div className="flex items-center space-x-2 flex-1 min-w-0">
                            ...
                            <Label htmlFor="standard" className="flex items-center flex-1 min-w-0">
                              <Truck className="h-4 w-4 mr-2 text-muted-foreground flex-shrink-0" />
                              <div className="min-w-0">
                          ...
                          <span className="font-medium flex-shrink-0">₦1,500</span>
                        </div>

                        <div className="flex items-center justify-between space-x-2 p-3 border rounded-md">
                          <div className="flex items-center space-x-2 flex-1 min-w-0">
                            <RadioGroupItem value="express" id="express" className="flex-shrink-0" />
                            <Label htmlFor="express" className="flex items-center flex-1 min-w-0">
                              <Truck className="h-4 w-4 mr-2 text-muted-foreground flex-shrink-0" />
                              <div className="min-w-0">
                          ...
                          <span className="font-medium flex-shrink-0">₦3,000</span>
                        </div>

                        <div className="flex items-center justify-between space-x-2 p-3 border rounded-md">
                          <div className="flex items-center space-x-2 flex-1 min-w-0">
                            <RadioGroupItem value="pickup" id="pickup" className="flex-shrink-0" />
                            <Label htmlFor="pickup" className="flex items-center flex-1 min-w-0">
                              <MapPin className="h-4 w-4 mr-2 text-muted-foreground flex-shrink-0" />
                              <div className="min-w-0">
                                <span className="font-medium block">Store Pickup</span>
                                <p className="text-xs text-muted-foreground">Collect from seller's location</p>
                              </div>
                            </Label>
                          </div>
                          <span className="font-medium flex-shrink-0">Free</span>
                        </div>
                      </RadioGroup>
                    </div>
                    ...
                    <div>
                      ...
                      <Textarea placeholder="Add any special instructions for delivery..." className="resize-none" />
                    </div>
                  </div>
                      ...
                      <div className="flex items-start space-x-2">
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <div className="flex items-center mt-2">
                            <Truck className="h-4 w-4 text-muted-foreground mr-1 flex-shrink-0" />
                            <span className="text-sm text-muted-foreground">
                              {deliveryMethod === "standard" && "Standard Delivery (2-4 business days)"}
                ...
                <CardContent className="p-4 md:p-6">
                  ...
                  <div className="space-y-3 mb-6">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className="text-sm">{deliveryFee === 0 ? "Free" : formatPrice(deliveryFee)}</span>
                    </div>
                    <Separator className="my-4" />
                    <div className="flex justify-between font-bold">
                      <span>Total</span>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-start space-x-2">
                      <input type="checkbox" id="terms" className="rounded border-gray-300 mt-0.5 flex-shrink-0" />
                    ...
                    <div className="flex items-start space-x-2">
                      <input type="checkbox" id="whatsapp" className="rounded border-gray-300 mt-0.5 flex-shrink-0" />
                      <Label htmlFor="whatsapp" className="text-xs leading-relaxed">
                        Send order updates via WhatsApp
                      </Label>
                    </div>
                  </div>
