...
//                 Thanks for trusting <span className="font-bold capitalize">{plugBusinessName}</span> with this
//                 purchase, <span className="font-bold capitalize">{buyerName}</span>.
//               </p>
//             </div>
//           </div>
...
//                       We're handpicking and packing your items with care. You'll
//                       get tracking details via email once your package ships.
//                     </p>
//                   </div>
//                 </div>
...
//                   You're now part of the <span className="font-bold capitalize">{plugBusinessName}</span> family. We can't
//                   wait for you to experience what makes us special.
//                 </p>
//               </div>
//             </CardContent>
//           </Card>
...
//                     Discover other amazing products from <span className="font-bold capitalize">{plugBusinessName}</span> that
//                     others are loving.
//                   </p>
