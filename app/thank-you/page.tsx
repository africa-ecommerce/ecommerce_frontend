          ...
          <div className="text-center space-y-4">
            ...
            <div className="space-y-2">
              ...
              <p className="text-muted-foreground">
                Thanks for trusting {plugBusinessName} with this purchase, {buyerName}
              </p>
            </div>
          </div>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div className="space-y-2">
                    <h2 className="font-semibold text-foreground text-lg">
                      Your {plugBusinessName} order is being prepared
                    </h2>
                    <p className="text-muted-foreground text-sm leading-relaxed">
                      We're handpicking and packing your items with care. You'll get tracking details via email once your package ships.
                    </p>
                  </div>
                </div>
          ...
          <Card className="bg-gradient-to-r from-primary/5 to-accent/5 border-primary/20">
            <CardContent className="p-6">
              <div className="text-center space-y-3">
                ...
                <p className="text-sm text-muted-foreground">
                  You're now part of the {plugBusinessName} family. We can't wait for you to experience what makes us special.
                </p>
              </div>
            </CardContent>
          </Card>
              ...
              <CardContent className="p-6">
                <div className="space-y-4">
                  ...
                  <p className="text-white/90 text-sm">
                    Discover other amazing products from {plugBusinessName} that your friends are loving.
                  </p>
