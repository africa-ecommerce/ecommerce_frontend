                ...
                <div className="space-y-4">
                  <div className="flex items-start space-x-3">
                    ...
                    <div className="space-y-2">
                      ...
                      <p className="text-muted-foreground text-sm leading-relaxed">
                        Since you selected cash payment, we have sent payment
                        instructions and account details to your email for
                        completing your order payment.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="bg-orange-100 rounded-lg p-4 border-l-4 border-orange-400">
                    <div className="flex items-start space-x-2">
                      ...
                      <div className="space-y-1">
                        ...
                        <span className="text-xs text-orange-700">
                          Check your inbox for account details and payment steps
                        </span>
                      </div>
                    </div>
                  </div>
