...
//                           <p className="text-sm text-muted-foreground">support@pluggn.com.ng</p>
...
//                           <p className="text-sm text-muted-foreground">+234 (0) 915 142 5001</p>
...
export default function HelpPage() {
  ...
  // Handle form submission - Direct email
...
---
This message was sent from the Help & Support page.
    `.trim()
    );

    // Open email client with pre-filled data
    const mailtoLink = `mailto:support@pluggn.com.ng?subject=${subject}&body=${body}`;
                      ...
                      {submitStatus === "success" && (
                        <div className="p-4 bg-green-50 border border-green-200 rounded-md">
                          <p className="text-green-800 text-sm">
                            Your email client should now open with your message
                            pre-filled. Please send the email to complete your
                            support request.
                          </p>
                        </div>
                      )}
