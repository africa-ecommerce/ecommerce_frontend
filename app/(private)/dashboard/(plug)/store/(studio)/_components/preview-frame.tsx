...
//       {/* Device type indicator - higher z-index to ensure visibility */}
//       <div className="absolute top-4 left-4 bg-white rounded-lg shadow-md p-2 text-sm z-50">
