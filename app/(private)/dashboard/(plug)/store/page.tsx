    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-4 grid-cols-1 xs:grid-cols-2 lg:grid-cols-4">
        <Card>
          ...
          <CardContent>
            <div className="text-lg md:text-xl font-bold">{analyticsData.visits}</div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-lg md:text-xl font-bold">{analyticsData.customers}</div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-lg md:text-xl font-bold">{analyticsData.orders}</div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-lg md:text-xl font-bold">{analyticsData.revenue}</div>
              ...
              <AlertDialog>
                ...
                <AlertDialogContent className="max-w-sm mx-auto">
                  ...
                  <AlertDialogFooter className="flex-col sm:flex-row gap-2">
                    ...
                    <AlertDialogAction className="bg-destructive text-destructive-foreground hover:bg-destructive/90 w-full sm:w-auto"
                    onClick={deleteStore}
                    >
                      Delete Store
                    </AlertDialogAction>
