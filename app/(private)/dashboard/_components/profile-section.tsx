...
import { errorToast, successToast } from "@/components/ui/use-toast-advanced";
import { mutate } from "swr";
import { passwordSchema, profileSchema, supplierAddressSchema } from "@/zod/schema";
...
export function ProfileSection({ onBack, userType }: ProfileSectionProps) {
  ...
  const updateProfile = async (data: any) => {
    ...
    if (userType === "SUPPLIER") {
      ...
      formData.append("supplierAddress", JSON.stringify(data.supplierAddress));
    } else {
                  ...
                  {userType === "PLUG" ? (
                    ...
                    <div className="space-y-6">
                      <div className="border-t pt-6">
                        <h3 className="text-lg font-medium mb-4">Pickup Address Information</h3>
