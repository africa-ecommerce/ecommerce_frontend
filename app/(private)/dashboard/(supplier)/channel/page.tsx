    ...
    <div className="min-h-screen bg-white relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-10 pointer-events-none">
        <svg className="w-full h-full" xmlns="http://www.w3.org/2000/svg">
          <defs>
            ...
            >
              ...
              <circle
                ...
                strokeWidth="3"
              />
              <circle cx="70" cy="245" r="4" fill="rgb(249 115 22)" />
              <circle cx="80" cy="250" r="4" fill="rgb(249 115 22)" />
              <circle cx="90" cy="255" r="4" fill="rgb(249 115 22)" />
              <path
          ...
          <rect width="100%" height="100%" fill="url(#doodles-bg)" />
        </svg>
      </div>
