...
export function AddProductModal({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="fixed inset-0 z-50 flex items-end justify-center md:items-center bg-transparent shadow-none p-0">
        <motion.div
                    ...
                    <div className="space-y-6">
                      ...
                      {formData.category && (
                        <div className="rounded-xl border bg-muted/30 p-4">
                          ...
                          <ul className="space-y-3">
                            {(
                              categoryRecommendations as Record<
                                string,
                                string[]
                              >
                            )[formData.category]?.map((req, i) => (
                  ...
                  {currentStep === 1 && (
                    <div className="space-y-6">
                      ...
                      {!formData.hasVariations ? (
                        <div className="rounded-xl border bg-muted/30 p-4 text-center">
                          <p className="text-muted-foreground">
                            This product will be managed as a single item with
                            no variations.
                          </p>
                          <p className="text-sm text-muted-foreground mt-2">
                            You'll be able to set stock in the next step.
                        ...
                        <div className="flex flex-col items-center justify-center rounded-xl border-2 border-dashed bg-muted/30 p-8 text-center">
                          ...
                          <p className="text-sm text-muted-foreground mb-4">
                            Add variations with different sizes, colors and
                            stock levels.
                          </p>
                          <Button onClick={addVariation} type="button">
                                ...
                                <div className="grid gap-4 grid-cols-1 md:grid-cols-2">
                                  ...
                                  <div className="space-y-3 pb-4">
                                    <ColorPicker
                                      ...
                                      value={variation.color || []}
                                      onChange={(colors) =>
                                        updateVariation(index, "color", colors)
                                      }
                      ...
                      <div className="rounded-xl border bg-muted/30 p-6">
                        ...
                        <div className="grid gap-4 text-sm">
                            ...
                            formData.color.length > 0 && (
                              <div className="flex justify-between items-center">
                                ...
                                <div className="flex flex-wrap gap-1">
                                  {getColorDisplay(formData.color).map(
                                    (color) => (
                                      <Badge
                                        key={color?.value}
                                        variant="secondary"
                          ...
                          <div className="flex justify-between">
                            ...
                            <span className="font-medium">
                              {formData.imageUrls?.length || 0} uploaded
                            </span>
                          </div>
                        </div>
                      </div>
