  ...
  return (
    <div className="relative w-full h-full flex items-center justify-center px-6">
      ...
      >
        ...
        {/* Content */}
        <div className="relative h-full flex flex-col items-center justify-center px-8 md:py-12 py-8 text-center">
          {/* Animated star icon */}
          <motion.div
          ...
          >
            <div className="relative">
              <motion.div
                ...
                className="md:w-20 md:h-20 w-16 h-16 bg-gradient-to-br from-orange-400 to-orange-500 rounded-full flex items-center justify-center shadow-lg"
              >
                <Sparkles className="md:w-10 md:h-10 w-8 h-8 text-white" strokeWidth={2} />
              </motion.div>
              {/* Pulsing ring */}
              <motion.div
                animate={{
          ...
          <motion.h2
            ...
            className="text-xl md:text-3xl font-bold text-gray-900 md:mb-4 mb-3 text-balance"
          >
          ...
          >
            <Link
              ...
              className="group relative inline-flex items-center justify-center px-8 md:py-4 py-3 text-base md:text-lg font-semibold text-white bg-gradient-to-r from-orange-500 to-orange-600 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 active:scale-95 overflow-hidden"
            >
              {/* Shimmer effect */}
              <motion.div
