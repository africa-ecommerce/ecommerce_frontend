              ...
              >
                <div className="text-center py-6">
                  ...
                  <p className="text-slate-500">
                    We're preparing your website and making it accessible to the
                    world.
                  </p>
                </div>
                ...
                <div className="relative py-10 px-4 rounded-xl bg-gradient-to-r from-blue-50 to-indigo-50 overflow-hidden">
                  <div className="relative z-10">
                    ...
                    <p className="text-slate-600 text-center max-w-md mx-auto">
                      Your website will be instantly published and available for
                      anyone to view.
                    </p>
                  </div>
                ...
                <div className="space-y-3">
                  <div className="flex items-center">
                    ...
                    <p className="text-sm text-slate-600">
                      Your website will have a unique address
                    </p>
                  </div>
                  <div className="flex items-center">
                    <CheckCircle className="h-5 w-5 text-green-500 mr-3" />
                  ...
                  <div className="flex items-center">
                    <CheckCircle className="h-5 w-5 text-green-500 mr-3" />
                    <p className="text-sm text-slate-600">
                      Instant updates whenever you make changes
                    </p>
                  </div>
                </div>
