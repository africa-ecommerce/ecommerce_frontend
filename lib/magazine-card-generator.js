...
async function renderSellerSection(ctx, {
  ...
  // Seller name
  ctx.font = `500 ${baseFontSize * 0.95}px "Inter", -apple-system, BlinkMacSystemFont, sans-serif`;
  ctx.fillStyle = '#2c2c2c';
  ctx.textAlign = 'left';
  ctx.textBaseline = 'top';
  ...
  ctx.font = `300 ${baseFontSize * 0.85}px "Inter", -apple-system, BlinkMacSystemFont, sans-serif`;
  ctx.fillStyle = '#8b7355';
  ctx.letterSpacing = '0.05em';
