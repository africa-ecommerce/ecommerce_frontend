...
export async function createLuxuryMagazineCard({
  ...
  customization = {
    ...
    headerSpacing: 0.06, // Reduce to move image up, increase to move down
    imageStartY: 0.14,   // Reduce to move image up, increase to move down
    ...
    logoSize: 0.08,        // Reduce to make logo smaller
    
    // Background colors (you can modify these)
    cardColors: {
      primary: '#f8f3ed',     // Main card background (more brown)
