...
export async function createLuxuryMagazineCard({
  ...
  customization = {
    ...
    imageStartY: 0.12,   // Reduce to move image up, increase to move down
    imageHeight: 0.59,   // Reduce to make image smaller, increase to make larger
...
async function renderSellerSection(ctx, {
  ...
  ctx.font = `300 ${baseFontSize * 1}px "Inter", -apple-system, BlinkMacSystemFont, sans-serif`;
  ctx.fillStyle = '#8b7355';
  ctx.letterSpacing = '0.05em';
